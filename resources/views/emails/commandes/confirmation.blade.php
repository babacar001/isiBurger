...
<div class="container my-5">
    ...
    <table class="table table-bordered table-striped">
        ...
        @foreach($commande->burgers as $burger)
            <tr>
                ...
                <td>{{ number_format($burger->pivot->prix_unitaire / 100, 2) }} FCFA</td>
                <td>{{ number_format(($burger->pivot->prix_unitaire * $burger->pivot->quantite) / 100, 2) }} FCFA</td>
            </tr>
        @endforeach
        </tbody>
    </table>
    ...
    <footer class="mt-5">
        <p>Merci,<br> {{ config('ISI Burger') }}</p>
    </footer>
</div>
